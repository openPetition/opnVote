...
export function handleElectionRegisterPublicKeySet(event: ElectionRegisterPublicKeySetEvent): void {
...
export function handleElectionResultsPublished(event: ElectionResultsPublishedEvent): void {
...
export function handleElectionStatusChanged(event: ElectionStatusChangedEvent): void {
  let entity = new ElectionStatusChanged(event.transaction.hash.concatI32(event.logIndex.toI32()))
  entity.electionId = event.params.electionId
...
export function handleElectionUpdated(event: ElectionUpdatedEvent): void {
  let entity = new ElectionUpdated(event.transaction.hash.concatI32(event.logIndex.toI32()))
  entity.electionId = event.params.electionId
  entity.votingStartTime = event.params.votingStartTime
  entity.votingEndTime = event.params.votingEndTime
  entity.registrationStartTime = event.params.registrationStartTime
...
export function handleVoteUpdated(event: VoteUpdatedEvent): void {
  let entity = new VoteUpdated(event.transaction.hash.concatI32(event.logIndex.toI32()))
  entity.electionId = event.params.electionId
  entity.voter = event.params.voter
  entity.voteEncrypted = event.params.voteEncrypted
  entity.voteEncryptedUser = event.params.voteEncryptedUser
...
export function handleVoterAuthorized(event: VoterAuthorizedEvent): void {
  let entity = new VoterAuthorized(event.transaction.hash.concatI32(event.logIndex.toI32()))
...
export function handleVoterRegistered(event: VoterRegisteredEvent): void {
  let entity = new VoterRegistered(event.transaction.hash.concatI32(event.logIndex.toI32()))
  entity.registerId = event.params.registerId
  entity.electionId = event.params.electionId
  entity.voterId = event.params.voterId
...
export function handleVotersAuthorized(event: VotersAuthorizedEvent): void {
  let entity = new VotersAuthorized(event.transaction.hash.concatI32(event.logIndex.toI32()))
  entity.apId = event.params.apId
  entity.electionId = event.params.electionId
  ...
  electionEntity.authorizedVoterCount = electionEntity.authorizedVoterCount!.plus(
    BigInt.fromI32(numberOfVotersAuthorized),
  )
  electionEntity.save()
}

export function handleVotersRegistered(event: VotersRegisteredEvent): void {
  let entity = new VotersRegistered(event.transaction.hash.concatI32(event.logIndex.toI32()))
  entity.registerId = event.params.registerId
  entity.electionId = event.params.electionId
  entity.voterIds = event.params.voterIds
  ...
  electionEntity.registeredVoterCount = electionEntity.registeredVoterCount!.plus(
    BigInt.fromI32(numberOfVotersRegistered),
  )
  electionEntity.save()
}
