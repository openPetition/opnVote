...
contract VoteScript is Script {
    ...
    function run() public {
        ...
        bytes memory voteEncryptedUser = hex"51146f0fd4e24449cf04f8bbeb62afb5754d4f10b3c2945b6534254221df67ae7c"; // Dummy Data

        vm.startBroadcast();
        opnVote.vote(
            electionId, voter, svsSignature, voteEncrypted, voteEncryptedUser, unblindedElectionToken, unblindedSignature
        );
    }
}
